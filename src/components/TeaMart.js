...
const TeaMart = () => {
  ...
  const fetchVegMenu = async () => {
    const data = await fetch(
      "https://www.swiggy.com/api/instamart/category-listing?categoryName=Tea%2C+Coffee+and+More&storeId=1381358&offset=0&filterName=&taxonomyType=All%20Listing"
    );
