...
const MunchMart = () => {
  ...
  const fetchVegMenu = async () => {
    const data = await fetch(
      "https://www.swiggy.com/api/instamart/category-listing?categoryName=Munchies&storeId=1381358&offset=0&filterName=&taxonomyType=All%20Listing"
    );
